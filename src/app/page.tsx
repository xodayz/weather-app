...
import { getDayOrNightIcon } from "@/utils/dayOrNightIcons";
import FWDetails from "@/components/FWDetails";
...
export default function Home() {
  ...
  return (
    <div className="flex flex-col gap-4 bg-[#E1E5F2] min-h-screen">
      <Navbar location={data?.city.name} />
      <main className="px-3 max-w-7xl mx-auto flex flex-col gap-9 w-full pb-10 pt-4 bg-[#E1E5F2] rounded">
        {/* Today weather */}
          ...
          <section className="space-y-4">
                ...
                <div className="flex gap-10 sm:gap-16 overflow-x-auto w-full justify-between pr-3">
                  {data?.list.map((d, i) =>
                    <div key={i} className="flex flex-col justify-between gap-2 items-center text-xs font-semibold">
                      ...
                      <WeatherIcons iconName={getDayOrNightIcon(d.weather[0].icon, d.dt_txt)} />
            ...
            <div className="flex gap-4">
              ...
              <Container className="w-fit justify-center flex-col px-4 items-center">
                ...
                <WeatherIcons iconName={getDayOrNightIcon(firstData?.weather[0].icon ?? "", firstData?.dt_txt ?? "")} />
              </Container>
              <Container className="bg-[#1F7A8C] px-6 gap-4 justify-between overflow-x-auto">

                <FWDetails
                  visibility={metersToKilometers(firstData?.visibility ?? 10000)}
                  humidity={`${firstData?.main.pressure} %`}
