            ...
            <nav className="shadow-sm sticky top-0 left-0 z-50 bg-white">
                <div className="h-[80px] w-full flex justify-between items-center max-w-7xl px-3 mx-auto">
                    <p className=" flex items-center justify-center gap-2">
                        ...
                        <LiaSun className="text text-3xl mt-1 text-yellow-400" />
                    </p>
                    {/*   */}
                    <div className="flex items-center gap-5">
                        <section className="flex gap-2 items-center">
                            <TbCurrentLocation
                                ...
                                className="text-2xl text-black hover-opacity-80 cursor-pointer" />
    ...
    return (
        <>
            {((showSuggestions && suggestions.length > 1) || error) && (
                <ul className="mb-4 bg-white absolute border top-[44px] left-0 border-gray-300 rounded-md min-w-[200px] flex flex-col gap-1 py2 px-2">
